...
public class KuaiQianService {
    ...
    public Map<String, String> generateFormData(Integer uid,String phone, BigDecimal rechargeMoney) {
        ...
        String bgUrl = "https://8x5r837231.goho.co/pay/kq/rece/notify";
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
    ...
    public void handleQueryOrder() {
        Set<String> orderIds = stringRedisTemplate.boundZSetOps(RedisKey.KEY_ORDERID_SET).range(0, -1);
            ...
            if ((StringUtils.isNotBlank(response))){
                ...
                if (detailObject != null){
                    ...
                    if (detailJsonObject != null){
                        int result = rechargeService.handleKQNotify(detailJsonObject.getString("orderId"),
                                detailJsonObject.getString("payAmount"), detailJsonObject.getString("payResult"));
